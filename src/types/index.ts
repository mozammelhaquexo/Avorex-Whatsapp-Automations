...
// ============================================================
// License & Package System (migration 031)
// ============================================================

export type LicenseStatus = 'active' | 'used' | 'disabled' | 'expired';
export type LicenseDuration = '7 Days' | '30 Days' | '90 Days' | '180 Days' | '1 Year' | 'Lifetime' | 'Custom';
export type LicenseAction = 'activate' | 'validate' | 'deactivate' | 'transfer' | 'expire';
