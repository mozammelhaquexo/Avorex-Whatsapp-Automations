...
export const metadata: Metadata = {
  title: {
    default: "Avorex Technologies",
    template: "%s — Avorex Technologies",
  },
  description: "WhatsApp Automation & CRM by Avorex Technologies. Contact: +8801575813644, Email: avorextechnologies@gmail.com",
  robots: {
    index: false,
    follow: false,
  },
